  ...
  return (
    ...
    >
      <div className="modal-content">
        {
          props.hasHeader && <div className="modal-header bg-light-primary d-flex align-items-center">
            <h3 className="modal-title">{title}</h3>
            {props.rightControl && props.rightControl()}
            {
              props.showCloseButton && <button onClick={onClose} type="button" className="close rounded-pill">
