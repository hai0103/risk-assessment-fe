...
$(document).ready(function() {
    ...
    $('#add-contact-item').on( 'click', function (e) {
        ...
        userDataTable.row.add( [
            ...
            '<a data-toggle="modal" data-target="#EditContactModal" class="primary edit mr-1"><i class="fal fa-pen"></i></a>'+
                ...
                '<span class="dropdown">'+
                    ...
                    '<span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right">'+
                        ...
                        '<a href="#" class="dropdown-item"><i class="feather icon-trash-2"></i> Delete</a>'+
